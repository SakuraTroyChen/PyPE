...
deepspeed tinyllava/train/train.py \
    ...
    --output_dir ./checkpoints/llava_factory/pretrain/tiny-llava-${LLM_VARIANT}-${VT_VARIANT}-${VERSION}-pretrain-inv_pyramid1x \
    --num_train_epochs 1 \
    ...
    --run_name tiny-llava-${LLM_VARIANT}-${VT_VARIANT}-${VERSION}-pretrain-inv_pyramid1x
